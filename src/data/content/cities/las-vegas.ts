export const lasVegasContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Under NV Energy's net metering program, excess electricity your solar panels generate gets sent back to the grid and credited to your account at 75% of the retail rate. Those credits apply to future bills automatically. Systems must be under 25 kW to qualify, and unused annual credits may be paid out at a lower rate — so proper system sizing matters."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. Studies show solar panels add 3–4% to home value on average. In Las Vegas, that's $15,000–$25,000 in added value on a median home. And because of Nevada's property tax exemption, that added value doesn't increase your property tax bill."
    },
    {
  ...
  cta: {
    headline: "Ready to Cut Your NV Energy Bill?",
    subheadline: "Get a free savings analysis — no pressure, no obligation.",
